...
GEO_EXIST_BUILD = "ge_3.2 attrib unleashed, 2026-09-02"
...
ATTRIB_PROMPT = (
    ...
    "Указывай город только если уверен. Фрагменты, которые не являются гео-объектами, НЕ включай "
    "в ответ. Если объект есть и в самой локации ({location}) — НЕ включай его в ответ.\n"

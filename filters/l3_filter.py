...
# -----------------------------------------------------------------------------
# АКТИВНЫЙ ПРОМПТ — драфт 14.
# История:
#   Драфт 12 — без блока юрисдикции, чистый. 99% чистоты VALID.
#                Минус: пропускает РФ-бренды (жарден, реавиз, нордин и т.д.)
#   Драфт 13 — блок юрисдикции в начале с правилом "не уверен → 0".
#                Сломал UA-кейсы: viaflor, гурт, квит, Киев, Одесса, Украина.
#                Откатили.
#   Драфт 14 — блок юрисдикции в КОНЦЕ с правилом "не уверен → 1".
#                Цель: не сместить фокус модели на гео в начале.
#                Цель: сохранить UA-кейсы при отсутствии данных за/против региона.
# -----------------------------------------------------------------------------

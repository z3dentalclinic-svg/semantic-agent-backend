...
# -----------------------------------------------------------------------------
# АКТИВНЫЙ ПРОМПТ — драфт 12 (откатились по результатам тестов).
# Лучший результат на 3 сидах в среднем. Не ломает UA-бренды и города.
# Простой, быстрый. Гео-фильтрация — задача верхних слоёв (brands.json, geo_db).
# -----------------------------------------------------------------------------

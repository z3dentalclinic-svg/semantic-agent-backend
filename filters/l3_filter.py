...
# -----------------------------------------------------------------------------
# АКТИВНЫЙ ПРОМПТ — драфт 16.
# История:
#   Драфт 12 — без блока юрисдикции, чистый. 99% чистоты VALID.
#                Минус: ~9 РФ-брендов проходят в VALID (жарден, реавиз, нордин,
#                лодэ, отзовик, налоговый вычет и т.д.).
#   Драфт 13 — блок юрисдикции В НАЧАЛЕ с "не уверен → 0".
#                Сломал UA-кейсы (viaflor, гурт, квит, "украина" в запросе).
#                Откатили.
#   Драфт 14 — блок юрисдикции В КОНЦЕ с "не уверен → 1".
#                Меньше резал, но всё ещё ломал явные UA-кейсы. Откатили.
#   Драфт 16 — расширенный список региональных маркеров встроен прямо в
#                правило 1 ПРИОРИТЕТА. Не отдельный блок — уточнение к
#                существующему правилу. Цель: явно обязать модель проверять
#                бренды/гос/юр/гео маркеры на соответствие региону поиска.
# -----------------------------------------------------------------------------

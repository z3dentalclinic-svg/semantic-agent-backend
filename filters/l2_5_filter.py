...
# V2 (активный): ноль по сущности — только при двух фактах («знаю, что это» И
# «знаю, что не сочетается»); неопознанное имя читается как сущность из
# тематики SEED (самонастройка по сиду, без коммерческих категорий);
# фактическая неточность запроса — валид (люди ищут то, чего не знают).

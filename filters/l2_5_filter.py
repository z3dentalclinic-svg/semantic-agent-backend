...
# V3 (активный, тест): + критерий региона (сущность только другой страны),
# + критерий места (другой населённый пункт/страна, чем локация SEED —
# осознанная смена чаплино-решения), + запрет придумывать оправдания.
# Щиты: места внутри локации SEED; сущности из самого SEED; неопознанное.

"""
FGS Parser API - Semantic keyword research with geo-filtering1
"""
...
# --- Ворота доступа (ag_0.5): владелец / 4 суперпользователя без лимитов / тестеры с балансом. После всех include_router. ---
...
# --- Личный кабинет (cab_0.1): сохранённые прогоны, проекты-дерево, выписка, отзывы, заявки. После ворот. ---

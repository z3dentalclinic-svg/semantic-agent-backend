...
# Модель для merge-вызова. Тест: проверяем что выше — мозги модели или потолок промпта.
# Если pro не справится → промпт нужно править. Если справится → можно опускаться к 3-flash.

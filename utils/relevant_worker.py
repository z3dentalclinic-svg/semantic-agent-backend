...
# поисковый интент, что у SEED. V3.2 в цепочке не трогается.
# Правка узла 3/3 (счётчик закрыт): + инфо-запросы не повод для 0 — прогон «ремонт
# пылесосов» срезал 58 инфо-ключей (как отремонтировать/своими руками/можно ли),
# которые цепочка держит валидами. Следующий сбой узла = смена схемы, не 4-я правка.
...
Информационные запросы о том же предмете и том же действии (как ..., можно ли ..., своими руками, инструкция, видео) — это тот же интент на этапе изучения, не повод для 0.

...
BUILD = "ms_0.1"   # [MEM-MODE mw_1.3] было: BUILD = "mw_1.3"
...
INFO_GROUPS = ("info_intent",)   # группы L0 → фразовый поток; contacts/action остаются цензору (решение Andrew — пока так)
GEO_GROUPS = ("geo",)
...
PRUNE_SEM_PROMPT = (
    ...
    "состояние товара, другой канал покупки, другой бренд, модель, характеристику, смежный товар или услугу, "
    "которых в запросах рекламодателя нет.\n"

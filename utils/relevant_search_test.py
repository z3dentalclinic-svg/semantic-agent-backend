...
Схлопывай только настоящих близнецов — где сценарий
поиска один и подсказки будут те же:
- то же слово в другом падеже или числе
- пары вида "починка / починить"
Из группы близнецов бери одного, самого употребимого.
Однокоренность сама по себе — не причина схлопывать:
существительное чаще означает поиск услуги, глагол —
намерение сделать (в том числе самому); если сценарии
поиска разойдутся — это разные кандидаты, бери оба.

...
Два правила близнецов, они СИЛЬНЕЕ осей выше:
1. Глагол и существительное от того же глагола (одно
   действие в двух формах одного слова) — всегда одна
   точка входа. Часть речи такую пару не разводит.
2. Слово и его расширение в словосочетание (то же слово
   плюс уточняющее) — всегда одна точка входа.
...
в словосочетание.
Два правила близнецов сильнее осей: глагол и
существительное от того же глагола — одна точка входа;
слово и его расширение в словосочетание — одна точка входа.
Такие пары не разделяй никогда.

...
EXTEND_TASK_VARIANTS = (
    ...
    "в списке вариантов — добавь только те, которые люди в этом регионе реально ищут (спрос есть и на новые, "
    "и на подержанные; варианты без текущего спроса не нужны). У каждого — написания, которыми его набирают; "
    "признаки у новых вариантов не пиши. "
...
EXTEND_TASK_MISSING = (
    ...
    "в списках, — добавь их и закрой каждый добавленный пункт под-группой (по одному запросу). Существующие пункты "
    "чек-листа, оси и новые варианты не трогай — ими заняты другие части."
)

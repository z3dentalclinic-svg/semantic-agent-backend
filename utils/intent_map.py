...
im_0.11 (2026-09-19): ось-часть — строго оси, без под-групп и пунктов чек-листа (на Sol она писала 2.9k токенов, 47 с);
  добавлять недостающие этапы/особенности и закрывать их — право частей чек-листа.
...
EXTEND_TASK_AXES = (
    "Твоя часть работы — только оси карты: дополни написания предмета, варианты предмета и их написания, признаки "
    "вариантов, города региона; ключи, которые ещё не отнесены ни к одной под-группе, отнеси к существующей под-группе. "
    "Под-группы, запросы, этапы (journey) и особенности (specifics) не добавляй — ими заняты другие части; "
    "в ответе оставь groups пустым, если нечего отнести из ключей."
)
# im_0.10: "Если в списках journey или specifics не хватает этапов или особенностей — добавь их и закрой каждый добавленный
#           пункт под-группой." — было в оси-части, перенесено в части чек-листа (im_0.11)
EXTEND_TASK_PART = (
    "Твоя часть работы — эти пункты чек-листа:\n{items}\n"
    "Для каждого проверь, закрыт ли он под-группой в текущей карте; незакрытые закрой новыми под-группами "
    "(по одному запросу). Если рядом с твоими пунктами не хватает этапов пути или особенностей ниши и региона — "
    "добавь их в journey / specifics и закрой каждый под-группой. Чужие пункты, оси (варианты, признаки, города) "
    "и ключи не трогай — ими заняты другие части."
)
